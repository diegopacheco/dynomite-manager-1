...
public class CassandraInstanceFactory implements IAppsInstanceFactory
{
    ...
    public AppsInstance create(String app, String id, String instanceID, String hostname, String ip, String zone, Map<String, Object> volumes, String payload, String rack)
    {
        try {
